...
test('npm tarball shape — includes required runtime adapter files and no repo artifacts', () => {
  ...
  for (const required of [
    ...
    // Phase 22 — opencode adapter (commands + plugin + agents + skills)
    'adapters/opencode/adapter.js',
    'adapters/opencode/instructions/AGENTS.md',
    'adapters/opencode/instructions/surfaces.md',
    'adapters/opencode/plugins/momentum.js',
    'adapters/opencode/commands/scout.md',
    'adapters/opencode/commands/dispatch.md',
    'adapters/opencode/commands/handoff.md',
    'adapters/opencode/commands/continue.md',
    'adapters/opencode/commands/review-code.md',
    'adapters/opencode/commands/swarm.md',
    'adapters/opencode/agents/momentum-reviewer-security.md',
    'adapters/opencode/agents/momentum-reviewer-qa.md',
    'adapters/opencode/agents/momentum-reviewer-architecture.md',
    'adapters/opencode/agents/swarm-supervisor.md',
    'adapters/opencode/skills/momentum-orient/SKILL.md',
