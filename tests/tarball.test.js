...
test('npm tarball shape — includes required runtime adapter files and no repo artifacts', () => {
  ...
  for (const required of [
    ...
    // Phase 16: brainstorm-gate.sh moved to core/scripts/ (shared across
    // Claude Code + Codex). It still ships in every install via the
    // generic scripts/ copy path.
    'core/scripts/brainstorm-gate.sh',
    'adapters/codex/adapter.js',
    'adapters/codex/hooks.json',
    'adapters/codex/instructions/AGENTS.md',
    'adapters/codex/commands/review-code.md',
    ...
    'adapters/antigravity/commands/review-code.md',
    'adapters/antigravity/agents/momentum-reviewer-security.toml',
    'adapters/antigravity/agents/momentum-reviewer-qa.toml',
    'adapters/antigravity/agents/momentum-reviewer-architecture.toml',
