...
| 18 | Swarm Parity (Codex + Antigravity) | Not Started (target v0.20.3 — displaced from v0.20.2 by Phase 17.5) | Codex `.codex/agents/swarm-supervisor.toml` + MCP cwd shim; Antigravity Agent Manager workflow + `.agents/skills/swarm-supervisor/SKILL.md`. `core/swarm/` is platform-agnostic; only adapter wiring is deferred. |
