...
| 7b | Agent Runtime Compatibility | In Progress (target v0.9.0) | Adapter Contract v3; Codex adapter MVP (`AGENTS.md`, `.codex/hooks.json`, Codex command recipes); Claude regression coverage; ENH-018 tarball-shape test |
