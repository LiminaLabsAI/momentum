---
title: Swarm
description: One session, many projects, one feature. Conductor + per-project supervisors deliver a cross-project feature end-to-end in a single session. Phase 17 (v0.20.0) — Claude Code.
---
