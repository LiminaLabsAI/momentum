...
function init(targetDir, agent) {
  ...
  // Phase 16: copy the entire core/scripts/ tree (not just check-history-reminder
  // alone). brainstorm-gate.sh moved into core/scripts/ here as part of bringing
  // Codex to parity with Claude Code on the PreToolUse hook.
  copyDir(
